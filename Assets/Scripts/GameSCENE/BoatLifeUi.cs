...
public class BoatLifeUi : MonoBehaviour
{
    ...
    [SerializeField] private SpriteRenderer mainSail = default;

    [SerializeField] private Sprite[] boat = default;
    [SerializeField] private Sprite[] sail = default;
